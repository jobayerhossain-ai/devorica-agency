...
export function CTA() {
    return (
        <SectionLayout background="dark" className="relative overflow-hidden">
            ...
            <AnimatedReveal
                stagger={true}
                className="relative z-10 p-10 sm:p-14 lg:p-20 rounded-[40px] border border-white/10 bg-white/[0.02] backdrop-blur-2xl overflow-hidden group shadow-2xl shadow-black/80"
            >
                {/* Hover Glow Effect */}
