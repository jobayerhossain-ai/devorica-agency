        ...
        <div className="min-h-screen bg-[#0B0B0B] text-foreground pt-32 pb-20 px-4 md:px-8">
            <div className="max-w-4xl mx-auto">
                ...
                <div className="space-y-12 text-[#D1D5DB] leading-relaxed">
                    ...
                    <section>
                        <h2 className="text-2xl font-heading font-semibold text-foreground mb-4">3. Service Engagements</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-2xl font-heading font-semibold text-foreground mb-4">4. Disclaimer</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-2xl font-heading font-semibold text-foreground mb-4">5. Limitations</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-2xl font-heading font-semibold text-foreground mb-4">6. Governing Law</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-2xl font-heading font-semibold text-foreground mb-4">7. Contact Information</h2>
