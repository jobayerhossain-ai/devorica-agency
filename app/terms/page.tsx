        ...
        <div className="min-h-screen bg-surface-alt text-heading pt-32 pb-20 px-4 md:px-8">
            <div className="max-w-4xl mx-auto">
                ...
                <div className="space-y-12 text-body leading-relaxed">
                    <section>
                        <h2 className="text-2xl font-heading font-semibold text-heading mb-4">1. Agreement to Terms</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-2xl font-heading font-semibold text-heading mb-4">2. Use License</h2>
                        <p className="mb-4">
                    ...
                    <section>
                        <h2 className="text-2xl font-heading font-semibold text-heading mb-4">3. Service Engagements</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-2xl font-heading font-semibold text-heading mb-4">4. Disclaimer</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-2xl font-heading font-semibold text-heading mb-4">5. Limitations</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-2xl font-heading font-semibold text-heading mb-4">6. Governing Law</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-2xl font-heading font-semibold text-heading mb-4">7. Contact Information</h2>
                        <div className="mt-4 p-6 rounded-2xl bg-glass border border-glass-border">
                            <p className="font-semibold text-heading">Legal Department</p>
