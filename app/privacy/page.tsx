        ...
        <div className="min-h-screen bg-[#0B0B0B] text-foreground pt-32 pb-20 px-4 md:px-8">
            <div className="max-w-4xl mx-auto">
                ...
                <div className="space-y-12 text-[#D1D5DB] leading-relaxed">
                    <section>
                        <h2 className="text-2xl font-heading font-semibold text-foreground mb-4">1. Introduction</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-2xl font-heading font-semibold text-foreground mb-4">2. Information Collection</h2>
                        <p className="mb-4">
                    ...
                    <section>
                        <h2 className="text-2xl font-heading font-semibold text-foreground mb-4">3. Use of Your Information</h2>
                        <p className="mb-4">
                    ...
                    <section>
                        <h2 className="text-2xl font-heading font-semibold text-foreground mb-4">5. Your Rights</h2>
                        <p>
                    ...
                    <section>
                        ...
                        <div className="mt-4 p-6 rounded-2xl bg-white/5 border border-white/10">
                            <p className="font-semibold text-foreground">Devorica Agency</p>
