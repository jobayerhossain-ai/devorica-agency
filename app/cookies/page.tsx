        ...
        <div className="min-h-screen bg-surface-alt text-heading pt-32 pb-20 px-4 md:px-8">
            <div className="max-w-4xl mx-auto">
                ...
                <div className="space-y-12 text-body leading-relaxed">
                    <section>
                        <h2 className="text-2xl font-heading font-semibold text-heading mb-4">1. What are Cookies?</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-2xl font-heading font-semibold text-heading mb-4">2. How We Use Cookies</h2>
                        <p className="mb-4">
                            We use cookies to:
                        </p>
                    ...
                    <section>
                        <h2 className="text-2xl font-heading font-semibold text-heading mb-4">3. Types of Cookies We Use</h2>
                        <div className="grid gap-6 mt-6">
                            <div className="p-6 rounded-2xl bg-glass border border-glass-border">
                                <h3 className="text-lg font-semibold text-heading mb-2">Essential Cookies</h3>
                                <p className="text-sm">Necessary for the website to function properly. These cannot be disabled.</p>
                            </div>
                            <div className="p-6 rounded-2xl bg-glass border border-glass-border">
                                <h3 className="text-lg font-semibold text-heading mb-2">Analytics Cookies</h3>
                            ...
                            <div className="p-6 rounded-2xl bg-glass border border-glass-border">
                                <h3 className="text-lg font-semibold text-heading mb-2">Preference Cookies</h3>
                    ...
                    <section>
                        <h2 className="text-2xl font-heading font-semibold text-heading mb-4">4. Managing Cookies</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-2xl font-heading font-semibold text-heading mb-4">5. Changes to This Policy</h2>
                        <p>
