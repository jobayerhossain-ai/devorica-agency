...
export default function CookiePolicy() {
    return (
        <div className="min-h-screen bg-[#0B0B0B] text-foreground pt-32 pb-20 px-4 md:px-8">
            <div className="max-w-4xl mx-auto">
                ...
                <div className="space-y-12 text-[#D1D5DB] leading-relaxed">
                    <section>
                        <h2 className="text-2xl font-heading font-semibold text-foreground mb-4">1. What are Cookies?</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-2xl font-heading font-semibold text-foreground mb-4">2. How We Use Cookies</h2>
                        <p className="mb-4">
                            We use cookies to:
                        </p>
                    ...
                    <section>
                        <h2 className="text-2xl font-heading font-semibold text-foreground mb-4">3. Types of Cookies We Use</h2>
                    ...
                    <section>
                        <h2 className="text-2xl font-heading font-semibold text-foreground mb-4">4. Managing Cookies</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-2xl font-heading font-semibold text-foreground mb-4">5. Changes to This Policy</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-2xl font-heading font-semibold text-foreground mb-4">6. Contact Us</h2>
                        <p>
